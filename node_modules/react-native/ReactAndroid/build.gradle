...
task prepareBoost(dependsOn: boostPath ? [] : [downloadBoost], type: Copy) {
    from(boostPath ?: tarTree(resources.gzip(new File(downloadsDir, "boost_${BOOST_VERSION}.tar.gz"))))
...
task prepareDoubleConversion(dependsOn: dependenciesPath ? [] : [], type: Copy) {
    from(dependenciesPath ?: tarTree(new File(downloadsDir, "double-conversion-${DOUBLE_CONVERSION_VERSION}.tar.gz")))
...
task prepareFolly(dependsOn: dependenciesPath ? [] : [], type: Copy) {
    from(dependenciesPath ?: tarTree(new File(downloadsDir, "folly-${FOLLY_VERSION}.tar.gz")))
...
task prepareGlog(dependsOn: dependenciesPath ? [] : [], type: Copy) {
    from(dependenciesPath ?: tarTree(new File(downloadsDir, "glog-${GLOG_VERSION}.tar.gz")))
